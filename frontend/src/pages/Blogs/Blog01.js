    ...
    <>
      ...
      <div className={styles.container1}>
        <Grid container spacing={5}>
          ...
          >
            <div>
              ...
              <p className={styles.para}>
                By eating a combination of different foods, including fruits,
                vegetables, legumes, nuts, and whole grains.you will reduce your
                risk of malnutrition and non-communicable diseases (NCDs) such
          ...
          >
            <div>
              ...
              <p className={styles.para}>
                ...
                maintaining a healthy weight and prevent heart disease. The fat
                intake should be 25 to 35 percent of total calories from fat.
              </p>
            </div>
          </Grid>
          <Grid
          ...
          >
            <div>
              <h3 className={styles.title}>4.Consume less salt and sugar</h3>
              <p className={styles.para}>
                Most people get their sodium through salt. Reduce your salt
                intake to 5g per day, equivalent to about one teaspoon. On the
                other hand, consuming excessive amounts of sugar increases the
                risk of tooth decay and unhealthy weight gain. Reduce your sugar
                to 50g or about 12 teaspoons.
              </p>
            </div>
          </Grid>
          <Grid
          ...
          >
            <div>
              ...
              <p className={styles.para}>
                ...
                quitting to help reduce your risk for chronic disease. Smoking
                tobacco causes NCDs such as lung disease, heart disease and
                stroke.
              </p>
            </div>
          </Grid>
          ...
          >
            <div>
              ...
              <p className={styles.para}>
                ...
                physically active can help you lead a healthier and happier
                life. People who exercise regularly have a lower risk of
                developing many long-term (chronic) conditions, such as heart
